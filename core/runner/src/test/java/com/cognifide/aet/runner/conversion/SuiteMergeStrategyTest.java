...
public class SuiteMergeStrategyTest {
  ...
  public void merge_checkVersionIncrement(String patternResource, String currentResource) throws Exception {
  ...
  @TestWith({"conversion/pattern.json;conversion/current.json"})
  public void merge_checkPatternsRewritten(String patternResource, String currentResource) throws Exception {
    final Suite pattern = readSuite(patternResource);
    final Suite current = readSuite(currentResource);
    final Suite merged = SuiteMergeStrategy.merge(current, pattern);
  ...
  @TestWith({"conversion/pattern.json;conversion/current.json"})
  public void merge_checkNewCollectStepAddedAndOldRemoved(String patternResource, String currentResource)
          throws Exception {
    final Suite pattern = readSuite(patternResource);
    final Suite current = readSuite(currentResource);
    final Suite merged = SuiteMergeStrategy.merge(current, pattern);
