...
public class CollectDispatcherTest extends StepManagerTest {
  ...
  protected StepManager createTested() throws JMSException {
    return new CollectDispatcher(timeoutWatch, connection, 1000L, 2, scheduler, suiteIndexWrapper);
  }
  ...
  private com.cognifide.aet.communication.api.metadata.Test mockTest(String name, int numberOfUrls) {
