...
public class CollectionResultsRouterTest extends StepManagerTest {
  ...
  protected StepManager createTested() throws JMSException {
    final com.cognifide.aet.communication.api.metadata.Test mockedTest = Mockito.mock(com.cognifide.aet.communication.api
            .metadata.Test.class);
    ...
    CollectionResultsRouter collectionResultsRouter = new CollectionResultsRouter(timeoutWatch, connection, 100L,
  ...
  public void onMessage_whenSuccess_expectChangeListenersNotifiedAndMessageSent() throws Exception {
    ...
    CollectorResultData collectorResultData = CollectorResultData.createSuccessResult(url, "jmsID001",
            "testNameExample");
  ...
  public void onMessage_whenError_expectObserversNotified() throws Exception {
    ObjectMessage message = Mockito.mock(ObjectMessage.class);
    Url url = Mockito.mock(Url.class);
    CollectorResultData collectorResultData = CollectorResultData.createErrorResult(url, ProcessingError
