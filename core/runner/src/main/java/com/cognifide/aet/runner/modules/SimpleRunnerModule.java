...
public class SimpleRunnerModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(String.class).annotatedWith(Names.named("MAINTENANCE in"))
        .toInstance(MAINTENANCE_QUEUE_IN);
    ...
    bind(TestSuiteScope.class).annotatedWith(Names.named("testSuiteScope"))
        .toInstance(testSuiteScope);
    ...
    bind(SuiteIndexWrapper.class).toProvider(TestSuiteScope.<SuiteIndexWrapper>seededKeyProvider())
        .in(TestSuiteScoped.class);
  }
