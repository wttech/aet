...
public class W3cHtml5ComparatorFactory implements ComparatorFactory {
  ...
  @Override
  public ComparatorJob createInstance(Comparator comparator, ComparatorProperties comparatorProperties,
                                      List<DataFilterJob> dataFilterJobs) throws ParametersException {
    W3cHtml5Comparator w3cHtml5Comparator = new W3cHtml5Comparator(artifactsDAO, comparatorProperties,
