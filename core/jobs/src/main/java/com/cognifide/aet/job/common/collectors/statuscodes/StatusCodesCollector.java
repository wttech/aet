...
public class StatusCodesCollector implements CollectorJob {
  ...
  public StatusCodesCollector(ArtifactsDAO artifactsDAO, WebCommunicationWrapper webCommunicationWrapper,
  ...
  public CollectorStepResult collect() throws ProcessingException {
    ...
    try {
      ...
      final StatusCodesCollectorResult statusCodesCollectorResult = new StatusCodesCollectorResult(collectorProperties.getUrl());
      ...
      String resultId = artifactsDAO.saveArtifactInJsonFormat(collectorProperties, statusCodesCollectorResult);
