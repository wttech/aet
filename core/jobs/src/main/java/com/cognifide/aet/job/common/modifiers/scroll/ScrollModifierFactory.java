...
@Component
public class ScrollModifierFactory implements CollectorFactory {

  @Override
  public String getName() {
    return ScrollModifier.NAME;
  }
    ...
    return FeatureMetadata.builder()
            ...
            .addParameter(
                    ParameterMetadata.builder()
                            ...
                            .addValue("top")
                            .addValue("bottom")
                            .and().defaultValue("bottom")
                            .isMandatory(false)
                            .description("Page position to scroll")
                            .build()
            )
            .addParameter(
                    ParameterMetadata.builder()
                            ...
                            .withoutValues()
                            .isMandatory(false)
                            .description("css selector of the element to scroll page view into")
                            .build()
            )
            .addParameter(
                    ParameterMetadata.builder()
                            ...
                            .withoutValues()
                            .isMandatory(false)
                            .description("xpath of the element to scroll page view into")
                            .build()
            )
            .and()
            .withoutDeps()
            ...
            .group("Modifiers")
            .proxy(false)
            .wiki("https://github.com/Cognifide/aet/wiki/ScrollModifier")
            .build();
  }
}
