...
public abstract class W3cHtml5ComparatorJob implements ComparatorJob {
  ...
  public W3cHtml5ComparatorJob(ArtifactsDAO artifactsDAO, ComparatorProperties properties, List<DataFilterJob> dataFilterJobs) {
  ...
  protected ComparatorStepResult getComparatorStepResult(W3cHtml5ComparatorResult w3cComparatorResult) throws
          ProcessingException {
    String resultId;
    ...
    for (DataFilterJob<W3cHtml5ComparatorResult> dataFilterJob : dataFilterJobs) {
      modifiedW3cComparatorResult = dataFilterJob.modifyData(modifiedW3cComparatorResult);
    }
