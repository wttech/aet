...
public class ReplaceTextModifier extends WebElementsLocatorParams implements CollectorJob {
    ...
    public CollectorStepResult collect() throws ProcessingException {
        if (LOG.isDebugEnabled()) {
            LOG.debug("Replacing element for {}: {} on page: {} with attributeName : {} and value: {}. url: {}",
                    getSelectorType(), getSelectorValue(), webDriver.getCurrentUrl(), attributeName, value, properties.getUrl(),
                    properties.getUrl());
        }
        return replaceText();
    }
    ...
    public CollectorStepResult replaceText() throws ProcessingException {
        ...
        try {
            ...
            throw new ProcessingException("Can't replace text in +" + attributeName + " attribute in element: " + getSelectorType() + " ; " + getSelectorValue(), e);
        }
        return result;
    }
