...
@Component
public class HeaderModifierFactory implements CollectorFactory {

  @Override
  public String getName() {
    return HeaderModifier.NAME;
  }
  ...
  public CollectorJob createInstance(CollectorProperties properties, Map<String, String> parameters,
    ...
    HeaderModifier modifier = new HeaderModifier(webCommunicationWrapper);
