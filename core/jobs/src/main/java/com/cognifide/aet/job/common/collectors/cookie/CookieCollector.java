...
public class CookieCollector implements CollectorJob {
  ...
  CookieCollector(CollectorProperties properties, WebDriver webDriver, ArtifactsDAO artifactsDAO) {
  ...
  public CollectorStepResult collect() throws ProcessingException {
    ...
    final String artifactId = artifactsDAO.saveArtifactInJsonFormat(properties, cookies);
