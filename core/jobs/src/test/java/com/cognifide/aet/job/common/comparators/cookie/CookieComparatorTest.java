...
public class CookieComparatorTest extends AbstractComparatorTest {
  ...
  public void setUp() throws Exception {
    ...
    comparatorProperties = new ComparatorProperties(TEST_COMPANY, TEST_PROJECT, "pattern-result.json", "data-result.json");
  ...
  public void testCompare_compareSuccess() throws Exception {
    comparatorProperties = new ComparatorProperties(TEST_COMPANY, TEST_PROJECT, "identical-pattern-result.json", "data-result.json");
    tested = new CookieComparator(comparatorProperties, artifactDaoMock);
