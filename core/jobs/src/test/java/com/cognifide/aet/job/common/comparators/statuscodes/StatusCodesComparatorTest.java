...
public class StatusCodesComparatorTest extends AbstractComparatorTest {
  ...
  public void setUp() {
    ...
    comparatorProperties = new ComparatorProperties(TEST_COMPANY, TEST_PROJECT, null, "expected-data-200-result.json");
    tested = new StatusCodesComparator(artifactDaoMock, comparatorProperties, new ArrayList<DataFilterJob>());
