...
public class SuiteRemoveConditionTest {
  ...
  public void evaluate_whenOnlyOneSuite_expectFalseNoMatterConditions(String allSuitesVersions, Long removeOlderThan,
    ...
    SuiteRemoveCondition condition = new SuiteRemoveCondition(suites, mockRemoveConditions(removeOlderThan, keepNVersions));
    final boolean remove = condition.evaluate(mockSuiteVersionAndCreatedDate(evaluatedSuite, createdDaysAgo));
    assertFalse(remove);
  }
  ...
  public void evaluate_when8SuitesVersionsRemoveOldVersions_expectTrue(String allSuitesVersions, Long
          removeOlderThan, Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_when8SuitesVersionsKeepLastVersions_expectFalse(String allSuitesVersions, Long
          removeOlderThan, Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_when8SuitesRemoveOlderThanButAlwaysKeepLatestVersion_expectTrue(String allSuitesVersions, Long
          removeOlderThan, Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_when8SuitesKeepNewerThanAndAtLeastXVersions_expectTrue(String allSuitesVersions, Long
          removeOlderThan, Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_when8SuitesKeepNewerThanAndAtLeastXVersions_expectFalse(String allSuitesVersions,
                                                                               Long removeOlderThan, Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_whenDuplicatedVersion_expectRemoveOnlyOldVersions(String allSuitesVersions, Long removeOlderThan,
                                                                         Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  public void evaluate_whenDuplicatedVersion_expectKeepNewestVersion(String allSuitesVersions, Long removeOlderThan,
                                                                     Long keepNVersions, String evaluatedSuite, Integer createdDaysAgo) throws Exception {
    final List<Suite> suites = SUITES_LIST_COERCER.toList(allSuitesVersions);
  ...
  private Suite mockSuiteVersionAndCreatedDate(String input, int createdDaysAgo) {
    ...
    when(timestamp.get()).thenReturn(new DateTime().minusDays(createdDaysAgo).getMillis() - ONE_HOUR);
