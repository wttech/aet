...
@Component(service = RemoveOrphanedArtifactsProcessor.class)
public class RemoveOrphanedArtifactsProcessor extends RemoveArtifactsProcessor {

  private static final Logger LOGGER = LoggerFactory
      .getLogger(RemoveOrphanedArtifactsProcessor.class);
