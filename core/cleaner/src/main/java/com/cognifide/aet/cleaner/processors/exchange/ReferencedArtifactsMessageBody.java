...
public class ReferencedArtifactsMessageBody extends MessageBody<String> {
  ...
  public Set<String> getArtifactsToRemove() {
    return artifactsToRemove != null ? Collections.unmodifiableSet(artifactsToRemove) : Collections.<String>emptySet();
  }
  ...
  public Set<String> getArtifactsToKeep() {
    return artifactsToKeep != null ? Collections.unmodifiableSet(artifactsToKeep) : Collections.<String>emptySet();
  }
