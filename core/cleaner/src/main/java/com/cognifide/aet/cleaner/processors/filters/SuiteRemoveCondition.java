...
public class SuiteRemoveCondition {
  ...
  public SuiteRemoveCondition(final Collection<Suite> suiteRunVersions, final CleanerContext cleanerContext) {
  ...
  private int getKeepNVersionsOrSecureToLastVersion(CleanerContext cleanerContext) {
    return cleanerContext.getKeepNVersions() != null ? cleanerContext.getKeepNVersions().intValue() : 1;
  }
