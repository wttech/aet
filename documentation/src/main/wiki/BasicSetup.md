...
* Download and install [VirtualBox 5.0.26](https://www.virtualbox.org/wiki/Download_Old_Builds_5_0)
* Download and install [Vagrant 1.8.4](https://releases.hashicorp.com/vagrant/)
