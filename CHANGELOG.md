...
- [PR-prNumber](https://github.com/Cognifide/aet/pull/prNumber) Add algorithm to enable taking long screenshots without resolution-sleep-resolution workaround 
