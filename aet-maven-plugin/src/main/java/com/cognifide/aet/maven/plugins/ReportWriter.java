...
class ReportWriter {
	...
	public void write(String buildDirectory, String reportUrl, String saveAsFileName) throws IOException {
		...
		try {
			...
			if (directoryExists) {
				outputStream = new FileOutputStream(getTargetPath(buildDirectory, saveAsFileName));
