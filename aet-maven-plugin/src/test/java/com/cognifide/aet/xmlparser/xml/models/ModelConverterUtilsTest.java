...
public class ModelConverterUtilsTest {
	...
	@Test
	public void extendUrlsList_whenUrlsFromTheSameDomain_expectDifferentNamesForConvertedUrls() throws Exception {
		List<Url> urls = Lists.newArrayList(new Url("https://www.google.com?q=blah", null, null), new Url(
				"https://www.google.com", null, null));
	...
	public void extendUrlsList_withSpace_expectNamesEncoded() throws Exception {
		...
		final List<ExtendedUrl> extendedUrls = ModelConverterUtils.extendUrlsList(Collections.singletonList(url));
		String name1 = extendedUrls.get(0).getName();
