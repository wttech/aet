...
import com.cognifide.aet.maven.plugins.MessageProcessor;
import com.cognifide.aet.maven.plugins.ProcessingErrorMessageProcessor;
import com.cognifide.aet.maven.plugins.ProcessorFactory;
import com.cognifide.aet.maven.plugins.ProgressMessageProcessor;
...
public class ProcessorFactoryTest {
	...
	public void processTest_messageIsNull() throws JMSException {
		MessageProcessor processor = ProcessorFactory.produce(null, BUILD_DIR, runnerTerminator);
	...
	public void processTest_messageIdNotAnObject() throws JMSException {
		MessageProcessor processor = ProcessorFactory.produce(plainMessage, BUILD_DIR, runnerTerminator);
	...
	public void processTest_messageIsUnknownObject() throws JMSException {
		...
		MessageProcessor processor = ProcessorFactory.produce(message, BUILD_DIR, runnerTerminator);
	...
	public void processTest_reportMessage() throws JMSException {
		...
		assertThat(processor, instanceOf(ReportMessageProcessor.class));
	}
