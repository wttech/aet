 ...
 */
package com.cognifide.aet.job.common.datamodifiers.removelines;
...
public class RemoveLinesDataModifierTest {
	...
	public void testBadParameters(String dataRanges, String patternRanges) throws ParametersException {
		verifyException(tested, ParametersException.class).validateParameters(dataRanges, patternRanges);
	}
