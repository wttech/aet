...
public class ClientSidePerformanceCollectorFactory implements CollectorFactory {
	...
	public String getName() {
		return ClientSidePerformanceCollector.NAME;
	}
	...
	public CollectorJob createInstance(Node dataNode, Node patternNode, Map<String, String> params,
		...
		ClientSidePerformanceCollector collector = new ClientSidePerformanceCollector(dataNode,
				webCommunicationWrapper, collectorProperties, context);
