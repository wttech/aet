...
@Component
@Service
public class WaitForPageLoadedModifierFactory implements CollectorFactory {

	@Override
	public String getName() {
		return WaitForPageLoadedModifier.NAME;
	}
	...
	public CollectorJob createInstance(Node dataNode, Node patternNode, Map<String, String> params,
		...
		WaitForPageLoadedModifier modifier = new WaitForPageLoadedModifier(webCommunicationWrapper.getWebDriver());
