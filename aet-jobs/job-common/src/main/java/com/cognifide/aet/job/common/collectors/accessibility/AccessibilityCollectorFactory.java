...
public class AccessibilityCollectorFactory implements CollectorFactory {
	...
	@Override
	public CollectorJob createInstance(
			Node dataNode, Node patternNode, Map<String, String> params,
			WebCommunicationWrapper webCommunicationWrapper,
			CollectorProperties collectorProperties) throws ParametersException {
		AccessibilityCollector collector = new AccessibilityCollector(dataNode, collectorProperties,
