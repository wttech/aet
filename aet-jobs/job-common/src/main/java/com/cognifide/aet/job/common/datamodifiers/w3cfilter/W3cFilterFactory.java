...
@Component
@Service
public class W3cFilterFactory implements DataModifierFactory {
    @Override
    public String getName() {
        return W3cIssuesFilter.NAME;
    }

    @Override
    public DataModifierJob createInstance(Map<String, String> params) throws ParametersException {
        W3cIssuesFilter w3cIssuesFilter = new W3cIssuesFilter();
