...
@Component
@Service
public class AnalyticsComparatorFactory implements ComparatorFactory {

	@Override
	public String getType() {
		return AnalyticsComparator.COMPARATOR_TYPE;
	}

	@Override
	public String getName() {
		return AnalyticsComparator.COMPARATOR_NAME;
	}
	...
	public ComparatorJob createInstance(Node dataNode, Node patternNode, Node resultNode,
		...
		final AnalyticsComparator comparator = new AnalyticsComparator(dataNode, resultNode,
