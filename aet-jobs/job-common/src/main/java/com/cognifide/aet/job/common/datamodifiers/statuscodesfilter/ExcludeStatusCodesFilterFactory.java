 ...
 */
package com.cognifide.aet.job.common.datamodifiers.statuscodesfilter;
...
@Component
@Service
public class ExcludeStatusCodesFilterFactory implements DataModifierFactory {
	...
	@Override
	public DataModifierJob<StatusCodesCollectorResult> createInstance(Map<String, String> params)
