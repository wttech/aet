 ...
 */
public class CookieCollectorResult extends CollectorResult {

	private static final long serialVersionUID = -3358103006410847294L;

	private final HashSet<Cookie> cookies;

	public CookieCollectorResult(String url, Set<Cookie> cookies) {
		super(url);
		this.cookies = new HashSet<Cookie>(cookies);
	}
