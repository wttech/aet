...
@Component
@Service
public class JsErrorsFilterFactory implements DataModifierFactory {
	...
	@Override
	public DataModifierJob<JsErrorsCollectorResult> createInstance(Map<String, String> params) throws ParametersException {
