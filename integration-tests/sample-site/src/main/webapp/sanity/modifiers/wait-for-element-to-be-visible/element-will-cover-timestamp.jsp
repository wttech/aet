...
<div class="panel panel-default" style="position: relative;">
	<div class="panel-body" id="test-element" style="display: none; border: grey solid 3px; background: silver; position: absolute; left: 20px; top: 150px; width: 1000px; height: 500px; z-index: 1;">
