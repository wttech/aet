...
function inputHelper() {
     ...
     */
    this.fillTextInput = (textInputElement, text, elementName = 'Input element', timeout = 'medium') => {
     ...
     * @param timeout you can provide integer value (miliseconds), use one of the predefined values ('small', 'medium', 'long'). Defaults to 'medium' timeout equal to 10 seconds.
     */
    this.click = (clickableElement, elementName = 'Button element', timeout = 'medium') => {
     ...
     * @param timeout you can provide integer value (miliseconds), use one of the predefined values ('small', 'medium', 'long'). Defaults to 'medium' timeout equal to 10 seconds.
     */
    this.setCheckboxValue = (checkbox, value, elementName = 'Button element', timeout = 'medium') => {
...
module.exports = new inputHelper();
