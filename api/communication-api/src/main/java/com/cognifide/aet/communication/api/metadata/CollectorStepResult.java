...
public class CollectorStepResult extends StepResult {
  ...
  public static CollectorStepResult changeStatusToResetPattern(String artifactId, Payload payload) {
    return new CollectorStepResult(artifactId, payload, Status.RESET_PATTERN);
  }
