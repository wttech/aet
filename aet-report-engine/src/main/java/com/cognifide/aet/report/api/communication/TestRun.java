 ...
 */
package com.cognifide.aet.report.api.communication;
...
public class TestRun implements Serializable {
	...
	private static final long serialVersionUID = -7137575590904157823L;
	...
	private Map<String, List<ComparatorStep>> getMap(Set<ComparatorStep> comparatorSteps) {
		Map<String, List<ComparatorStep>> result = new HashMap<String, List<ComparatorStep>>();
		for (ComparatorStep comparatorStep : comparatorSteps) {
			List<ComparatorStep> list = result.get(comparatorStep.getType());
			if (list == null) {
				list = new ArrayList<ComparatorStep>();
