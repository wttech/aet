...
@Service
@Component(immediate = true, policy = ConfigurationPolicy.REQUIRE, description = "AET JMS Connection", label = "AET Default JMS Connection", metatype = true)
public class DefaultJmsConnection implements JmsConnection {
	...
	@Property(name = "url", label = "brokerUrl", description = "URL of the broker", value = "failover:tcp://localhost:61616")
