...
public class TestLifeCycleTest {
	...
	public void setUp() throws Exception {
		tested = new TestLifeCycle(testSuiteRun, jmsConnection, destination, suiteExecutor);
	}
	...
	public void constructor_withActiveMQDestination_expectAdvisoryConsumerCreated() throws Exception {
		...
		new TestLifeCycle(testSuiteRun, jmsConnection, activeMQDestination, suiteExecutor);
