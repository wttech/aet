...
public abstract class MessageObserverTest<T extends Observer> {
	...
	@Test
	public void update_whenDataIsNotSupportedMessage_expectMessageNotSent() throws Exception {
		tested.update(null, "NotValidMessage");
		verify(resultsProducer, times(0)).send(Matchers.<Message> any());
	}
