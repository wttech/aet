...
public class TestRunProcessor {
	 ...
	 * 
	 * @param testSuiteRun - test suite to process.
	 ...
	 */
	public void process(final TestSuiteRun testSuiteRun, Destination resultsDestination,
			boolean isMaintenanceMessage) {
		TestSuiteTask testSuitTask = testSuiteTaskFactory.create(testSuiteRun, resultsDestination, isMaintenanceMessage);
