 ...
 * @author michal.chudy
 */
public interface CollectorDispatcher {

	List<CollectMetadata> run(CollectMetadata nodeMetadata, CollectorJobData collectorJobData, WebCommunicationWrapper webCommunicationWrapper)
			throws AETException;
